...
function cardbody() {
    ...
    $.ajax({
        ...
        method: "GET"
          ...
          //new li
          var newLi = $("<li>").addClass("list-group-item").attr("onclick", "lulalivre()").text(response.name);
          ...
          uvURL = "http://api.openweathermap.org/data/2.5/uvi?appid=166a433c57516f51dfab1f7edaed8413&lat=" + latitude + "&lon=" + longitude;
          $.ajax({
              url: uvURL,
              method: "GET"
          }).then(function(uv){
